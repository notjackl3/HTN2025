...
def detect_objects_yolo_v8(image_bytes: bytes, confidence_threshold: float = 0.25) -> Dict:
...
def detect_objects_enhanced(image_bytes: bytes, confidence_threshold: float = 0.25) -> Dict:
